...
**Abductive Tactics (AT):**
These are ways of accomplishing things when confronted with navigating uncertain circumstances beyond anyone's control but in which you have a stake. AT generate: 
1. Facts of a different order than the facts given
2. Hypotheses and propositions on what to do or think that are always "best fit" and never final
